    ...
    public partial class DBInitialize : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsTankEmpty = table.Column<bool>(type: "bit", nullable: false),
                    IsCarDamaged = table.Column<bool>(type: "bit", nullable: false),
                    BillId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleBills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleBills_Bills_BillId",
                        column: x => x.BillId,
